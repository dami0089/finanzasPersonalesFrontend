...
const ModalNuevaSubCategoria = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await nuevaSubCategoria(idCategoria, nombreSubCategoria, auth._id);
  ...
  return (
    <Transition.Root show={modalSubCategoria} as={Fragment}>
      <Dialog
        as="div"
        className="fixed inset-0 z-50 overflow-y-auto"
        onClose={handleModalSubCategoria}
      >
            ...
            <div className="inline-block transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6 sm:align-middle">
              <div className="absolute right-0 top-0 hidden pr-4 pt-4 sm:block">
                <button
                  ...
                  onClick={handleModalSubCategoria}
                >
              ...
              <div className="sm:flex sm:items-start">
                ...
                <div className="mt-3 w-full text-center sm:ml-0 sm:mt-0 sm:text-left">
                  <Dialog.Title
                    as="h3"
                    className="text-l font-bold leading-6 text-gray-900 uppercase text-center"
                  >
                    Nueva SubCategoria para{" "}
                    <p className="text-blue-600">{nombreCategoria}</p>
                  </Dialog.Title>
                    ...
                    <>
                      <div className="mb-1">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setNombreSubCategoria(e.target.value)
                          }
                        />
                      </div>
...
export default ModalNuevaSubCategoria;
