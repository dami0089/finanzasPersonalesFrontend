...
const ModalNuevoSuperMercado = () => {
  ...
  return (
    <Transition.Root show={modalNuevoSuperMercado} as={Fragment}>
      <Dialog
        as="div"
        className="fixed inset-0 z-50 overflow-y-auto"
        onClose={handleModalSuperMercado}
      >
            ...
            <div className="inline-block transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6 sm:align-middle">
              <div className="absolute right-0 top-0 hidden pr-4 pt-4 sm:block">
                <button
                  ...
                  onClick={handleModalSuperMercado}
                >
                    ...
                    <>
                      <div className="mb-1">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setNombreSupermercado(e.target.value)
                          }
                        />
                      </div>
                      <div className="mb-1">
                        ...
                        <input
                          id="direccion"
                          type="text"
                          placeholder="Ingrese la direccion (optativo)"
                          className="mt-2 w-full resize-none rounded-md border-2 p-2 placeholder-gray-400"
                          value={direccionSupermercado}
                          onChange={(e) =>
                            setDireccionSupermercado(e.target.value)
                          }
                        />
                      </div>
...
export default ModalNuevoSuperMercado;
